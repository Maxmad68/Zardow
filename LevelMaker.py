...
class LevelMaker(object):
	def __init__(self, levelName = None):
		...
		self.environment = 'earth'

		if levelName == None:
			self.level = None
		else:
			self.level = import_level('Levels/Custom/'+levelName)
	...
	def refresh_display(self):
		...
		# Environment buttons
		earthImage = load_image('Ressources/Menu/earthIcon.png',(50,50))
		self.earth_button_rect = pygame.Rect(902,816,75,75)
		pygame.draw.rect(self.surface,(170,170,170),self.earth_button_rect)
		self.surface.blit(earthImage, (914, 829))
		
		spaceImage = load_image('Ressources/Menu/spaceIcon.png',(50,50))
		self.space_button_rect = pygame.Rect(902,907,75,75)
		pygame.draw.rect(self.surface,(170,170,170),self.space_button_rect)
		self.surface.blit(spaceImage, (914, 920))
			...
			if mouse_click: # Mouse press
				...
				if y < 800:
					...
					if self.toolbox.rect.collidepoint(mouse_position):
						...
						new_selected = row * 7 + column
						if new_selected < len(Tiles.identifiers):
							self.selectedId = new_selected
				...
				if just_clicked:
					...
					elif self.earth_button_rect.collidepoint(mouse_position):
						self.environment = "earth"
